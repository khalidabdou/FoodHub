 ...
 */
public class tab_new extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = tab_new_view.findViewById(R.id.recycler_view);
        ...
        adapter.setOnItemClickListener(new RecipeAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                Intent detailRecipes=new Intent(getActivity(),detailRecipe.class);
                detailRecipes.putExtra("id",documentSnapshot.getId());
                startActivity(detailRecipes);
            }
        });
